...
" Guicursor can be forced to be a block all the time
" set guicursor=

"Show absolute line number, as well as relativenumber line number
set nu
set relativenumber
...
" No creating swap files. Undo files are created instead.
set noswapfile
set nobackup
set undodir=~/.vim/undodir
set undofile

" incrementally highlight matches as you continue to type in search
set incsearch
...
" Mapping leader and localleader
...
" coc.nvim opens documentation on pressing K, similar to vimtex
" To instruct vimtex to override coc in .tex files, you must do the following:
